...
freq_plot <- ggplot(strategy, aes(session, freq)) +
  ...
  theme(plot.title = element_text(color = "black", face = "bold", hjust = 0.5)) +
  labs(x = "Session",
      y = "Number of Lectures per Week Implementing\n Take Break and Rejoin Class Strategy",
...
help_plot <- ggplot(strategy, aes(session, help)) +
  ...
  theme(plot.title = element_text(color = "black", face = "bold", hjust = 0.5)) +
  labs(x = "Session",
       y = "Helpfulness of Take Break and Rejoin Class Strategy",
       title = "Perceived Strategy Helpfulness",
       caption = "1 = Not Helpful at All\n 2 = Not Helpful\n 3 = Somewhat Helpful\n 4 = Helpful\n 5 = Very Helpful") 

help_plot

combined_plot_1 <- freq_plot + help_plot
...
combined_plot_2 <- freq_plot2 + help_plot2
```
