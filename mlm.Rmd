...
Effect size of change between phases: 10.17, *p* = .177

Slope: 1.84, *p* = .337


Although the effect size is rather large, it is not significant. Additionally, the obtained change in slope between phases is not significant, suggesting there is not a functional relation between the addition of individualized cognitive strategy instruction to psychoeducation and the achievement of student RTL targets. 
